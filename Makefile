...
pkgdatadir = $(datadir)/yast2-packagemanager-test
pkglibdir = $(libdir)/yast2-packagemanager-test
pkgincludedir = $(includedir)/yast2-packagemanager-test
top_builddir = .
...
ACLOCAL = ${SHELL} /suse/mir/co/yast-svn/trunk/packagemanager-test/missing --run aclocal-1.9
AGENT_LIBADD = -L$(libdir) -lscr
ALLOCA = 
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /suse/mir/co/yast-svn/trunk/packagemanager-test/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /suse/mir/co/yast-svn/trunk/packagemanager-test/missing --run autoconf
AUTOHEADER = ${SHELL} /suse/mir/co/yast-svn/trunk/packagemanager-test/missing --run autoheader
AUTOMAKE = ${SHELL} /suse/mir/co/yast-svn/trunk/packagemanager-test/missing --run automake-1.9
AWK = gawk
CC = gcc
...
MAKEINFO = ${SHELL} /suse/mir/co/yast-svn/trunk/packagemanager-test/missing --run makeinfo
OBJEXT = o
PACKAGE = yast2-packagemanager-test
PACKAGE_BUGREPORT = http://www.suse.de/feedback
PACKAGE_NAME = yast2-packagemanager-test
PACKAGE_STRING = yast2-packagemanager-test 2.12.1
PACKAGE_TARNAME = yast2-packagemanager-test
...
docdir = ${prefix}/share/doc/packages/yast2-packagemanager-test
exec_prefix = ${prefix}
...
infodir = ${prefix}/info
install_sh = /suse/mir/co/yast-svn/trunk/packagemanager-test/install-sh
libdir = /usr/lib
...
# all the .ycp and .pm files, we should separate texts from (exclude testsuite directory)
POT_SRC = $(shell find $(srcdir) -type d -name testsuite -prune , \
	-type f -name "*.ycp" -o -name "*.pm" | xargs egrep -l '^<?[[:space:]]*[Tt]extdomain>?') \
	$(POTFILES)
...
EXTRA_DIST = VERSION RPMNAME MAINTAINER configure.in.in \
	$(SUBDIRS_FILE) $(ACINCLUDE_FILE) $(POTFILES_FILE) $(if \
